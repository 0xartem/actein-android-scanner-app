...
public final class PreferencesActivity extends Activity
{
    ...
    public static final String KEY_CAT_QR_SETTINGS = "preferences_qr_settings";
    ...
    public static final String KEY_CAT_USER_SETTINGS = "preferences_user_settings";
    public static final String KEY_CHANGE_USER = "preferences_change_user";
    public static final String KEY_CHANGE_ADMIN_PWD = "preferences_change_admin_pwd";

    public static final String KEY_CAT_ACTIONS = "preferences_actions";
    ...
    public static final String KEY_CAT_DEVICE_BUG_WORKAROUNDS = "preferences_device_bug_workarounds";
